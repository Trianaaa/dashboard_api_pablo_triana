...
const OverviewPage = () => {
    ...
    const [projects, setProjects] = useState([
        { id: 1, name: 'AGUA POTABLE Y SANEAMIENTO BÁSICO', description: 'Proyecto enfocado en el mejoramiento de infraestructuras de agua potable y saneamiento básico en zonas rurales.', count: 5, dateCreated: '2023-09-22', dateModified: '2023-09-25', author: 'admin_pablo', group: 'AguaMinvivienda' },
    ...
    const [panels, setPanels] = useState([
        { id: 1, projectId: 1, name: 'ESTADO AL CORTE DE LOS PROYECTOS EN SEGUIMIENTO', count: 42, dateCreated: '2023-09-25', dateModified: '2023-09-25', preview: 'https://placehold.co/150x100/A78BFA/ffffff?text=Gráfico' },
        { id: 2, projectId: 1, name: 'ANÁLISIS DE CONSUMO HÍDRICO', count: 30, dateCreated: '2023-08-20', dateModified: '2023-09-05', preview: 'https://placehold.co/150x100/60A5FA/ffffff?text=Reporte' },
        { id: 3, projectId: 2, name: 'GENERACIÓN ENERGÉTICA SOLAR', count: 25, dateCreated: '2023-10-02', dateModified: '2023-10-08', preview: 'https://placehold.co/150x100/F87171/ffffff?text=Mapa' },
        { id: 4, projectId: 3, name: 'AVANCE DE OBRAS VIALES', count: 18, dateCreated: '2023-09-10', dateModified: '2023-10-15', preview: 'https://placehold.co/150x100/34D399/ffffff?text=Progreso' },
    ]);

    const [dashboards, setDashboards] = useState([
        { id: 1, projectId: 1, name: 'INDICADORES EN MATERIA DE AGUA POTABLE Y SANEAMIENTO BÁSICO V1', count: 3, dateCreated: '2023-09-26', dateModified: '2023-09-26', preview: 'https://placehold.co/150x100/34D399/ffffff?text=Tablero' },
        { id: 2, projectId: 1, name: 'RESUMEN EJECUTIVO DE SANEAMIENTO', count: 5, dateCreated: '2023-08-25', dateModified: '2023-09-10', preview: 'https://placehold.co/150x100/FBBF24/ffffff?text=KPIs' },
        { id: 3, projectId: 2, name: 'CUADRO DE MANDO ENERGÉTICO', count: 2, dateCreated: '2023-10-05', dateModified: '2023-10-12', preview: 'https://placehold.co/150x100/FB923C/ffffff?text=Análisis' },
        { id: 4, projectId: 3, name: 'SEGUIMIENTO PROYECTOS VIALES', count: 4, dateCreated: '2023-09-15', dateModified: '2023-10-20', preview: 'https://placehold.co/150x100/A78BFA/ffffff?text=Métricas' },
    ]);
